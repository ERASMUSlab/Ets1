...
> Primary osteoblasts (pOB) were isolated from Mus musculus at two age groups (young, 4 weeks; old, 20 months). Single-cell ATAC-seq and transcriptome profiling were performed using the Chromium Next GEM Single Cell Multiome ATAC + Gene Expression platform (Cat#CG000338, 10x Genomics), following the manufacturer’s recommendations with minor modifications. Approximately 1 × 10⁶ cells were transferred into a 1.5 mL low-binding microcentrifuge tube (Cat#022431021, Eppendorf, Germany) and pelleted by centrifugation at 500 × g for 5 min at 4 °C. Cells were washed twice with 1× PBS supplemented with 0.04% BSA, and the supernatant was carefully removed after each wash. Harvested nuclei were obtained by treating the cells with ice-cold 0.1× Lysis Buffer (10 mM Tris-HCl, 10 mM NaCl, 3 mM MgCl₂, 0.1% Tween-20, 0.1% Nonidet P40 substitute, 0.01% Digitonin, 1% BSA, and 1 U/μL RNase inhibitor) for 3 min on ice. The reaction was quenched by diluting with 1 mL of chilled Wash Buffer (10 mM Tris-HCl pH 7.4, 10 mM NaCl, 3 mM MgCl₂, 0.1% Tween-20, 1% BSA, 1 mM DTT, and 1 U/μL RNase inhibitor), followed by centrifugation. Nuclei pellets were resuspended in Diluted Nuclei Buffer, and quality was assessed by trypan blue staining to ensure >95% lysis. For library construction, nuclei were subjected to transposition using the Chromium Next GEM transposition mix, and gel bead-in-emulsion (GEM) generation was carried out on the Chromium Controller using Chip J. Subsequent incubation, clean-up, and pre-amplification steps were performed according to the manufacturer’s protocol. The amplified material was divided for parallel ATAC library preparation and cDNA amplification for gene expression library construction. ATAC libraries were sequenced on a NextSeq 2000 system (Illumina) using a P3 200 flow cell. ATAC libraries were sequenced on the Illumina NextSeq 2000 platform (P3 200 flow cell; 50/8/24/49 cycle configuration).
...
| ATAC processed BAM file at GM  | Fig. 4c | BAM | [link](https://drive.google.com/file/d/1gTJ3CrBroKLe0L6Hcq5Ix4Rvs5sQAUx6/view?usp=sharing) |
| ATAC processed BAM file at OM  | Fig. 4c | BAM | [link](https://drive.google.com/file/d/1X_LJoLNjlwGVJfRc7VHGzbzRb1d2NDrB/view?usp=sharing) |
...
| The landscape of unmatched signals shown in Figure 1I was visualized alongside histone activation marks (H3K27ac, H3K4me1, H3K4me3). The top two plots display the landscape of genes with unmatched signals at promoter regions and their corresponding gene expression changes. The bottom two plots show the landscape of genes with unmatched signals at enhancer regions and their associated gene expression changes. Pink indicates H3K27ac levels, green represents H3K4me3 levels, and purple indicates H3K4me1 levels. Regions marked with blue dashed lines represent areas where the signal decreased during differentiation, while regions marked with red dashed lines indicate increased signals. | Fig. 1j | [Link](http://147.47.56.90:8895/Ets1/4DN_official_202508/) |
...
| Micro-C contact maps at 5 kb resolution at representative loci, with TADs annotated. The upper right triangle shows TADs at GM, and the lower left triangle shows TADs at OM. TAD boundaries are marked with yellow dashed lines. Interaction strength is color-coded, with red indicating stronger and black indicating weaker interactions. | Fig. 2h | [Link](http://147.47.56.90:8895/Ets1/4DN_official_202508/) |
...
| Among the transcription factors (TFs) in Set 1 of Figure 4A, only those expressed in MC3T3-E1 cells were selected and visualized as a bar graph. For each of the 11 TFs, the change in chromatin accessibility from GM to OM was shown as green bars and used to sort the TFs. In addition, the change in TFBS levels between B-to-A and A-to-B regions was represented as purple bars. | Fig. 4b | [Link](http://147.47.56.90:8895/Ets1/4DN_official_202508/) | 
| V-plot showing chromatin accessibility dynamics surrounding Ets1 binding motifs, based on ATAC-seq data. The left and middle panels represent the GM and OM states, respectively. The right panel depicts the differential signal (OM minus GM), with red indicating increased accessibility upon differentiation and blue indicating regions with higher accessibility in the undifferentiated state. The purple dashed line indicates the upper boundary of the nucleosome-free region (NFR), the orange dashed line marks the region where mono-nucleosomes are predominantly distributed, and the red dashed line represents the region where di-nucleosomes are mainly located. | Fig. 4c | [Link](http://147.47.56.90:8895/Ets1/4DN_official_202508/) | 
| Based on Ets1 binding motifs, the binding status of Ets1 was classified into A-to-B and B-to-A shifts and visualized as a heatmap. | Fig. 4d | [Link](http://147.47.56.90:8895/Ets1/4DN_official_202508/) | 
