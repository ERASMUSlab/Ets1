...
| The landscape of unmatched signals shown in Figure 1I was visualized alongside histone activation marks (H3K27ac, H3K4me1, H3K4me3). The top two plots display the landscape of genes with unmatched signals at promoter regions and their corresponding gene expression changes. The bottom two plots show the landscape of genes with unmatched signals at enhancer regions and their associated gene expression changes. Pink indicates H3K27ac levels, green represents H3K4me3 levels, and purple indicates H3K4me1 levels. Regions marked with blue dashed lines represent areas where the signal decreased during differentiation, while regions marked with red dashed lines indicate increased signals. | Fig. 1i | [Link](http://147.47.56.90:8895/Ets1/4DN_official_202508/) |
