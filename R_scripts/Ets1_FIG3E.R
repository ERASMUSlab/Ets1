...
TOP_BOTTOM_MAT(chr_para = "chr15", ratio = 0.1, 
               histone_input="/data3/psg/Ets1/ProcessedData/GM_Histone_fit.bedpe",
               outpath = "/data3/psg/Ets1/ProcessedData/Histone_chr15_TOPBOTTOM_10_MAP.txt")

TOP_BOTTOM_MAT(chr_para = "chr15", ratio = 0.1, 
               histone_input="/data3/psg/Ets1/ProcessedData/GM_H3K27ac_fit.bedpe",
               outpath = "/data3/psg/Ets1/ProcessedData/H3K27ac_chr15_TOPBOTTOM_10_MAP.txt")

TOP_BOTTOM_MAT(chr_para = "chr15", ratio = 0.1, 
               histone_input="/data3/psg/Ets1/ProcessedData/GM_H3K4me1_fit.bedpe",
               outpath = "/data3/psg/Ets1/ProcessedData/H3K4me1_chr15_TOPBOTTOM_10_MAP.txt")

TOP_BOTTOM_MAT(chr_para = "chr15", ratio = 0.1, 
               histone_input="/data3/psg/Ets1/ProcessedData/GM_H3K4me3_fit.bedpe",
               outpath = "/data3/psg/Ets1/ProcessedData/H3K4me3_chr15_TOPBOTTOM_10_MAP.txt")

dataINPUT = read.table("/data3/psg/Ets1/ProcessedData/H3K27ac_chr15_TOPBOTTOM_10_MAP.txt",sep = "\t", header=T,fill = TRUE)
...
H3K27ac_chr15_MAP = read.table("/data3/psg/Ets1/ProcessedData/H3K27ac_chr15_MAP.txt",sep = "\t", header=T,fill = TRUE)

data = H3K27ac_chr15_MAP
...
pheatmap(PCA,
         ...
         legend = FALSE,
         border_color = FALSE,
         color = colorRampPalette(c("white","white","pink1","pink1","pink2","pink3","pink4","pink4"))(100),
         breaks=seq(from=0,to=1300,length.out = 100))

dataINPUT = read.table("/data3/psg/Ets1/ProcessedData/H3K4me1_chr15_TOPBOTTOM_10_MAP.txt",sep = "\t", header=T,fill = TRUE)
...
H3K4me1_chr15_MAP = read.table("/data3/psg/Ets1/ProcessedData/H3K4me1_chr15_MAP.txt",sep = "\t", header=F,fill = TRUE)

data = H3K4me1_chr15_MAP
...
pheatmap(PCA,
         ...
         legend = FALSE,
         border_color = FALSE,
         color = colorRampPalette(c("white","white","purple1","purple1","purple2","purple3","purple4","purple4"))(100),
         breaks=seq(from=0,to=1300,length.out = 100))

dataINPUT = read.table("/data3/psg/Ets1/ProcessedData/H3K4me3_chr15_TOPBOTTOM_10_MAP.txt",sep = "\t", header=T,fill = TRUE)
...
H3K4me3_chr15_MAP = read.table("/data3/psg/Ets1/ProcessedData/H3K4me3_chr15_MAP.txt",sep = "\t", header=F,fill = TRUE)

data = H3K4me3_chr15_MAP
...
pheatmap(PCA,
         ...
         legend = FALSE,
         border_color = FALSE,
         color = colorRampPalette(c("white","white","green1","green1","green2","green3","green4","green4"))(100),
         breaks=seq(from=0,to=2000,length.out = 100))
